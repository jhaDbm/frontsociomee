                                                        ...
                                                        <form>
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-12">
                                                                    <a href="/payment" className="rounded-3 bg-current mb-2 mt-4 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-white d-block card-color">Add Card</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>       
