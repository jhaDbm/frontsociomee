                                ...
                                <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                                    ...
                                    <div className="card-body p-lg-5 p-4 w-100 border-0">
                                        <form action="#">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12 mb-0 text-center">
                                                    <a href="/password" className=" passwordset text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block">Save</a>
                                                </div>
                                            </div>
