...
const videoList = [
    {
        ...
        avater: 'ajay12.jpg',
        videourl: 'https://youtu.be/jpr82ruLaCI',
                                ...
                                <div className="col-lg-10">
                                    ...
                                    <div key={index} className="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                        <div className="card-body p-0 d-flex">
                                            <figure className="avatar me-3"><img src={`assets/images/${value.avater}`} alt="video" className="shadow-sm rounded-circle w45 videoImg" /></figure>
                                        ...
                                        <div className="card-body p-0 me-lg-5">
                                            <p className="fw-500 text-grey-500 lh-26 text-value font-xssss w-100 mb-0"> {value.des} <a href="/defaultvideo" className="fw-600 text-primary ms-2">See more</a></p>
                                        </div>
