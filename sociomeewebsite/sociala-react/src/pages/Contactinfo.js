                            ...
                            <div className="middle-wrap">
                                <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="col-lg-12 mb-0 mt-2 ps-0 text-center">
                                            <a href="/contactinformation" className=" contactinfo text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block">Save</a>
                                        </div>
                                    </form>
                                    </div>
                                </div>
