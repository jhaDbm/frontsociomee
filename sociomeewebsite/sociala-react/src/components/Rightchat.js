    ...
    constructor() {
      ...
      updateDimensions() {
        if(window.innerWidth < 500) {
          this.setState({ width: 100, height: 102 });
        } else {
    ...
    render() {
        ...
        return (
            ...
            <div id="main-content-wrap" className={`right-chat nav-wrap mt-2 right-scroll-bar ${this.state.width > 1500 ? "active-sidebar" : " "}`}>
                            ...
                            {chatMember.map((value , index) => (
                                ...
                                <li  key={index} className="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                                    <figure className="avatar float-left mb-0 me-2">
                                        <img src={`assets/images/${value.imageUrl}`} alt="avater" className="w35 groupimg " />
                                    </figure>
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                                ...
                                <span className="btn-round-sm bg-primary-gradiant me-3 ls-3 text-white font-xssss fw-700">
                                    <img src="assets/images/ajayjha.jpg" className="groupimg" />
                                </span>
                                <h3 className="fw-700 mb-0 mt-0">
                            ...
                            <li className="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                                ...
                                <img src="assets/images/ajay.jpg" className="groupimg" />
                                </span>
                                <h3 className="fw-700 mb-0 mt-0">
                ...
                <div className={`modal-popup-chat chatbar ${menuClass}`}>
                    <div className="modal-popup-wrap p-0 shadow-lg  ">
                        <div className="modal-popup-header w-100 border-bottom">
                            <div className="card p-3 d-block border-0 d-block">
                                <figure className="avatar mb-0 float-left me-2">
                                    <img src="assets/images/ajay.jpg" alt="avater" className="w35 me-1 groupimg" />
                                </figure>
                                <h5 className="fw-700 text-primary font-xssss mt-1 mb-1">Dhirendra kumar jha</h5>
                                <h4 className="text-grey-500 font-xsssss mt-1 mb-2"><span className="d-inline-block bg-success btn-round-xss m-0 available"></span> Available</h4>
                        ...
                        <div className="modal-popup-body w-100 p-3 h-auto">
                            <div className="message"><div className="message-content font-xssss lh-24 fw-500 w-100">Hi, how are you</div></div>
                            <div className="date-break font-xsssss lh-24 fw-500 text-grey-500 mt-2 mb-2">Mon 10:20am</div>
                            <div className="message self text-right mt-2"><div className="message-content font-xssss lh-24 fw-500"> I am  good.</div></div>
