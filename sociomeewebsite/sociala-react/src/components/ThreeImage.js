    ...
    return (
      ...
      >
        {({ measureRef }) => {
          ...
          return (
            <div ref={measureRef} style={{ height: 500, overflow: "hidden", borderRadius:"10" }}>
        ...
        <div class="card-body d-flex p-0 mt-3 mb-3"><a href=""
                    ...
                    <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Like</a>
                    <a href="" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss">
                        <i class="feather-message-circle text-dark text-grey-900 btn-round-sm font-lg">
                    </i>22 Comment</a><a href="" 
