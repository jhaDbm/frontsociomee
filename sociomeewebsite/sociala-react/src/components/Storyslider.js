    ...
    render() {
        ...
        return (
            <Slider {...storysettings}>
                ...
                <div key={index}>
                    <div className="card w125 h200 d-block border-0  crounded mx-auto d-block shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-0 me-3 storysetting  fit-image" style={{backgroundImage: `url("assets/images/${value.bgUrl}")`}}>
                        <div className="card-body d-block p-3 w-100 position-absolute bottom-0 text-center" >
