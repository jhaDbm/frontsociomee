    ...
    render() {
        return (
            <div className="card w-100 shadow-xss rounded-xxl overflow-hidden border-0 mb-3 mt-3 pb-3">
                ...
                style={{backgroundImage: `url("assets/images/ajay.jpg")`}}></div>
                <div className="card-body d-block pt-4 text-center">
                    <figure className="avatar mt--6 position-relative w75 z-index-1 w100 z-index-1 ms-auto me-auto"><img src="assets/images/ajay.jpg" alt="avater" className="p-1 bg-white rounded-xl w-100" /></figure>
