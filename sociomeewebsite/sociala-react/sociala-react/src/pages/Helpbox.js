                            ...
                            <div className="row justify-content-center">
                                <div className="col-xl-10">
                                    ...
                                    style={{backgroundImage: `url("assets/images/help-bg.png")`}}>
                                        <div className="card-body p-md-5 p-4 text-center bg-current">
                                            <h2 className="fw-700 display2-size text-white display2-md-size lh-2">Welcome to the SocioMee Commuinity!</h2>
                                            ...
                                            <div className="form-group w-lg-75 mt-4 border-light border p-1 bg-white rounded-3 ms-auto me-auto">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-4">
                                                        <a href="helpbox" className="w-100 d-block btn bg-current-set text-white font-xssss fw-600 ls-3 style1-input p-0 border-0 text-uppercase ">Search</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
