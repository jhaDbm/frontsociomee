        ...
        return (
            <Fragment> 
                ...
                <div className="main-wrap">
                    ...
                    <div className="row">
                        <div className="col-xl-7 d-none d-xl-block p-10 vh-50 bg-image-cover bg-no-repeat bgsetting">
                            <img src="https://front.sociomee.com/static/media/login-v2.da80012f.svg" />
                        </div>
