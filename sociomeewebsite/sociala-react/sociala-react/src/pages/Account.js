                ...
                <div className="main-content theme-dark-bg right-chat-active ">
                    ...
                    <div className="middle-sidebar-bottom " >
                        <div className="middle-sidebar-left ">
                            <div className="middle-wrap displaybg ">
                                <div className="card w-100 border-0 shadow-xs p-0 mb-4 ">
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-lg-4 text-center">
                                            <figure className="avatar ms-auto me-auto mb-0 mt-2 w100"><img src="assets/images/ajayjha.jpg" alt="avater" className="shadow-sm rounded-3 w-100" /></figure>
                                            <h2 className="fw-700 font-sm text-grey-900 mt-3">Dhirendra jha</h2>
                                            <h4 className="text-grey-500 fw-500 mb-3 font-xsss mb-4">Ajay</h4>    
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="form-group">
                                                    <label className="mont-font fw-600 font-xsss mb-2">Gender</label>
                                            ...
                                            <div className="col-lg-6 mb-3">
                                                <div className="form-group">
                                                    <label className="mont-font fw-600 font-xsss mb-2">DOB</label>
                                                    <input type="text" className="form-control" />
                                                </div>        
                                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 text-center">
                                                <a href="/accountinformation" className=" displaybg text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block">Save</a>
                                            </div>
                                        </div>
