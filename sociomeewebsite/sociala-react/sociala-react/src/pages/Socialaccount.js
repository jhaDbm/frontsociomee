                                        ...
                                        <div className="card-body p-lg-5 p-4 w-100 border-0">
                                            <form action="#">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-12 mb-0 mt-2 text-center ">
                                                        <a href="/socialaccount" className="bg-current bgcolor text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block">Save</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
