        ...
        return (
            <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                ...
                <div  key={index} className="card-body d-flex pt-0 ps-4 pe-4 pb-3 overflow-hidden">
                    ...
                    <h4 className="fw-700 text-black-900 font-xssss mt-2">{value.name} <span className="d-block font-xsssss fw-500 mt-1 lh-4 text-grey-500">{value.location}</span> </h4>
                </div>
